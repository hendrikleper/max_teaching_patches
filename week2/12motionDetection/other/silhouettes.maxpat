...
,
					"patching_rect" : [ 252.0, 555.941772, 125.0, 26.0 ],
					"saved_object_attributes" : 					{
						"description" : "",
						"digest" : "",
						"fontname" : "Helvetica",
...
, 			{
				"box" : 				{
					...
					"patching_rect" : [ 184.0, 190.0, 109.0, 20.0 ],
					"style" : "",
					"text" : "t 0 clear"
				}
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "", "bang" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 145.0, 490.0, 50.0, 20.0 ],
					"style" : ""
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "jit_matrix", "" ],
					"patching_rect" : [ 41.0, 510.0, 123.0, 20.0 ],
					"style" : "",
					"text" : "jit.op @op >"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "jit_matrix", "" ],
					"patching_rect" : [ 41.0, 450.0, 103.0, 20.0 ],
					"style" : "",
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "jit_matrix", "" ],
					"patching_rect" : [ 200.0, 419.0, 95.0, 20.0 ],
					"style" : "",
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "jit_matrix", "" ],
					"patching_rect" : [ 200.0, 340.0, 191.0, 20.0 ],
					"style" : "",
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "int" ],
					"patching_rect" : [ 148.0, 247.0, 34.0, 20.0 ],
					"style" : "",
					"text" : "< 10"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 4,
					"outlettype" : [ "int", "", "", "int" ],
					"patching_rect" : [ 148.0, 223.0, 91.0, 20.0 ],
					"style" : "",
					"text" : "counter"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 200.0, 275.0, 52.0, 20.0 ],
					"style" : "",
					"text" : "gate"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "bang", "" ],
					"patching_rect" : [ 148.0, 189.0, 32.5, 20.0 ],
					"style" : "",
					"text" : "t b l"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "jit_matrix", "" ],
					"patching_rect" : [ 256.0, 360.0, 124.0, 20.0 ],
					"style" : "",
					"text" : "jit.op @op * @val 0.1"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "jit_matrix", "" ],
					"patching_rect" : [ 200.0, 384.0, 75.0, 20.0 ],
					"style" : "",
					"text" : "jit.op @op +"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 271.0, 39.0, 39.0, 20.0 ],
					"style" : "",
					"text" : "close"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "jit_matrix", "" ],
					"patching_rect" : [ 148.0, 125.0, 151.0, 20.0 ],
					"style" : "",
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 216.0, 39.0, 37.0, 20.0 ],
					"style" : "",
					"text" : "open"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "bang" ],
					"patching_rect" : [ 148.0, 38.0, 65.0, 20.0 ],
					"style" : "",
					"text" : "qmetro 33"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "jit_matrix", "" ],
					"patching_rect" : [ 148.0, 100.0, 73.0, 20.0 ],
					"style" : "",
					"text" : "jit.rgb2luma"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "jit_matrix", "" ],
					"patching_rect" : [ 148.0, 76.0, 47.0, 20.0 ],
					"style" : "",
					"text" : "jit.grab"
				}
